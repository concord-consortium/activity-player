...
describe("Embeddable component", () => {
  it("renders a non-callout text component", () => {
    ...
    const wrapper = mount(<Embeddable embeddableWrapper={embeddableWrapper} questionNumber={1} pageLayout={PageLayouts.Responsive} pageSection={EmbeddableSections.InfoAssessment} pluginsLoaded={true} offlineMode={false} />);
