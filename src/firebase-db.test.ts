...
describe("Firestore", () => {
  ...
  it("creates answers with the correct metadata for authenticated users", () => {
    ...
    expect(appMock.firestore().doc().set).toHaveBeenCalledWith({
      ...
      report_state: "{\"mode\":\"report\",\"authoredState\":\"{\\\"version\\\":1,\\\"questionType\\\":\\\"open_response\\\",\\\"prompt\\\":\\\"<p>Write something:</p>\\\"}\",\"interactiveState\":\"{\\\"answerType\\\":\\\"open_response_answer\\\",\\\"answerText\\\":\\\"test\\\"}\",\"interactive\":{\"id\":\"123-ManagedInteractive\",\"name\":\"\"},\"version\":1}",
      resource_link_id: "2",
  ...
  it("creates answers with the correct metadata for an anonymous user", () => {
    ...
    expect(appMock.firestore().doc().set).toHaveBeenCalledWith({
      ...
      question_id: "managed_interactive_123",
      question_type: "open_response",
      report_state: "{\"mode\":\"report\",\"authoredState\":\"{\\\"version\\\":1,\\\"questionType\\\":\\\"open_response\\\",\\\"prompt\\\":\\\"<p>Write something:</p>\\\"}\",\"interactiveState\":\"{\\\"answerType\\\":\\\"open_response_answer\\\",\\\"answerText\\\":\\\"anonymous test\\\"}\",\"interactive\":{\"id\":\"123-ManagedInteractive\",\"name\":\"\"},\"version\":1}",
      resource_url: "http://example/resource",
